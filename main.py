...
class RedisCache:
    ...
    def set(self, key: str, value: str, expiry: int = 3600):  # Expiry in seconds (default: 1 hour)
        try:
...
async def google_search(query: str) -> str:
    ...
    # Initialisiere den Google GenAI Client
    client = genai.Client()
...
class Agent(BaseModel):
    ...
    async def generate_response(self, knowledge: dict, history: List[Dict], query: str) -> str:
        ...
        try:
            ...
            # Hier fügen wir das Hinterfragen und die Kritik hinzu
            prompt_text = (
            ...
            response = client.models.generate_content(
                ...
                config=GenerateContentConfig(  # Jetzt GenerationConfig verwenden
